...
<body>
    ...
    <div class="section-title">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                <h2>Your <span class="color-defult">Appointments</span></h2>
    ...
    <div id="bootstrap-touch-slider" class="carousel bs-slider fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="5000" >
        <div class="carousel-inner" role="listbox">
            <div class="item active" style="margin-left: 50px; padding-right: 100px">
                    <table class="table" style="color: #FFF">
                        ...
                        <tr>
                            <td>
                                <%= request.getAttribute("appointmentID"+i) %>
                            </td>
                            <td>
                                <%= request.getAttribute("userID"+i) %>
                            </td>
                            <td>
                               <%= request.getAttribute("name"+i) %>
                            </td>
                            <td>
                                <%= request.getAttribute("date"+i) %>
                            </td>
                            <td>
                                <%= request.getAttribute("time"+i) %>
                            </td>
                            <td>
                                <%= request.getAttribute("contact"+i) %>
                            </td>
                            <td>
                                <%= request.getAttribute("address"+i) %>
                            </td>
                            <td>
                                <a class="btn btn-primary" href='CancelAppointment?id=<%= request.getAttribute("appointmentID"+i) %>'>Cancel Appointment</a>
                            </td>
                        </tr>
                        <% } %>
                        </tbody>
