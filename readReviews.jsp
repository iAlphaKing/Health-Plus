    ...
    <div class="section-title">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                <h2>Your <span class="color-defult">Reviews</span></h2>
            ...
            <div class="item active" style="margin-left: 50px; padding-right: 100px"> -->
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <%= request.getAttribute("serviceName"+i) %>
                            </td>
                            <td>
                               <%= request.getAttribute("reviewDate"+i) %>
                            </td>
                            <td>
                                <%= request.getAttribute("rating"+i) %>
                            </td>
                            <td>
                                <%= request.getAttribute("reviewText"+i) %>
                            </td>
                        </tr>
                        <% } %>
                        </tbody>
