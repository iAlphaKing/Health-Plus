    ...
    <div id="bootstrap-touch-slider" class="carousel bs-slider fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="5000" >
        <div class="carousel-inner" role="listbox">
            <div class="item active" style="margin-left: 50px">
                    <h1 data-animation="animated fadeInRight"><span class="color-defult"> Write Review </span>Page</h1>
                    <form action="WriteReview" method="get" style="margin-right: 100px" class="row g-3">
                        <input type="hidden" name="placeId" value='<%= (String) request.getParameter("placeId") %>' />
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="text" class="form-label" data-animation="animated fadeInRight"><span class="color-defult">Review Text:</span></label>
                                <input type="textarea" data-animation="animated fadeInRight" id="text" name="text" class="input-field form-control" required>
                            </div>
                            <div class="col-md-6">
                                <label for="rating" class="form-label" data-animation="animated fadeInRight"><span class="color-defult">Rating:</span></label>
                                <select data-animation="animated fadeInRight" id="rating" name="rating" class="input-field form-control" required>
                                    <option class="input-field form-control" value="1">1</option>
                                    <option class="input-field form-control" value="2">2</option>
                                    <option class="input-field form-control" value="3">3</option>
                                    <option class="input-field form-control" value="4">4</option>
                                    <option class="input-field form-control" value="5">5</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <input type="submit" class="btn btn-primary" data-animation="animated fadeInRight" value="Submit">
                            </div>
                        </div>
                    </form>
            </div>
