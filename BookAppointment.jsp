        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="slide-text slide_style_left">
                    <h1 data-animation="animated fadeInRight"><span class="color-defult"> Book </span>Appointment</h1>
                    <form action="BookAppointment" method="post" class="row g-3">
                        ...
                        <input type="hidden" name="contact" value='<%= (String) request.getParameter("contact") %>' />
                        <input type="hidden" name="address" value='<%= (String) request.getParameter("address") %>' />
                        <input type="hidden" name="maps" value='<%= (String) request.getParameter("maps") %>' />
                        <input type="hidden" name="website" value='<%= (String) request.getParameter("website") %>' />
                        <div class="row">
                            <div class="col-md-6">
                                <label for="date" class="form-label" data-animation="animated fadeInRight"><span class="color-defult">Date:</span></label>
                                <input type="date" data-animation="animated fadeInRight" id="date" name="date" class="input-field form-control" required>
                            </div>
                            <div class="col-md-6">
                                <label for="time" class="form-label" data-animation="animated fadeInRight"><span class="color-defult">Time:</span></label>
                                <select data-animation="animated fadeInRight" id="time" name="time" class="input-field form-control" required>
                                    <option class="input-field form-control" value="10:00am">10:00am</option>
                                    <option class="input-field form-control" value="11:00am">11:00am</option>
                                    <option class="input-field form-control" value="12:00pm">12:00pm</option>
                                    <option class="input-field form-control" value="2:00pm">2:00pm</option>
                                    <option class="input-field form-control" value="3:00pm">3:00pm</option>
                                    <option class="input-field form-control" value="4:00pm">4:00pm</option>
                                    <option class="input-field form-control" value="5:00pm">5:00pm</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
