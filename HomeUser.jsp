        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="slide-text slide_style_left">
                    ...
                    <p data-animation="animated fadeInLeft">Our services give you the best <br> of modern healthcare to ensure you stay healthy, always.</p>
                    <a href="SearchLocations?method=All" class="btn btn-primary" data-animation="animated fadeInLeft">View Services</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="service-item text-center style-3">
                            ...
                            <h4><a href="SearchLocations?method=hospital">Hospitals</a></h4>
                            <div class="border-center"></div>
                            <p>Find hospitals in your vicinity and get professional help from top doctors. Book an appointment, check details, address, view it on maps, get opening and closing times.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="service-item text-center style-3">
                            <span class="flaticon-broken-bone"></span>
                            <h4><a href="SearchLocations?method=dental_clinic,dentist,doctor,medical_lab,physiotherapist">Clinics</a></h4>
                            <div class="border-center"></div>
                            <p>Find clinics in your vicinity and get reliable and personalized diagnosis from a doctor. Book quick appointments, check details, address, view it on maps, get opening and closing times.</p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="service-item text-center style-3">
                            <span class="flaticon-stomach"></span>
                            <h4><a href="SearchLocations?method=pharmacy,drugstore">Pharmacies</a></h4>
                            <div class="border-center"></div>
                            <p>Find top certified pharmacies in your vicinity. Check details, address, view it on maps, get opening and closing times.</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="service-item text-center style-3">
                            ...
                            <h4><a href="SearchLocations?method=fitness_center,spa,gym,sports_club,swimming_pool">Health Clubs</a></h4>
                            <div class="border-center"></div>
                            <p>Health is wealth. Find best health clubs in your vicinity. Book appointment for a viewing, check details, address, view it on maps, get opening and closing times.</p>
                        </div>
                    </div>
                </div>
            </div>
