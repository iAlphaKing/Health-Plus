        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                ...
                <div class="slide-text slide_style_left">
                    <h1 data-animation="animated fadeInRight">Appointment Booking <span class="color-defult">Successful</span></h1>
                    <p data-animation="animated fadeInLeft">Your appointment is booked on <%= request.getAttribute("date") %> at <%= request.getAttribute("time") %><br/>
                    You can view your appointment details by clicking on "View Appointments".</p>
                    <a href="HomeUser.jsp" class="btn btn-primary" data-animation="animated fadeInLeft">Great! Take Me Home</a>
                </div>
            </div>
        </div>
    </div>
